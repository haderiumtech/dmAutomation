...
public class XpathClass {
	...
	public final String homePopup = "//button[@title=\"Close (Esc)\"]";

	// Search bar test cases xpaths

	// public final String searchBar = "//input[@id='hello']"; //testing purpose to
	// fail test case intentionally
	...
	public final String storagePageUrl = "https://directmacro.com/storage-devices/storage.html?product_list_order=price&product_list_dir=desc";
	public final String networkPageUrl = "https://directmacro.com/networking-devices/switches/network-switches.html?product_list_order=price&product_list_dir=desc";
	public final String memoryPageUrl = "https://directmacro.com/memory.html?product_list_order=price&product_list_dir=desc";

	public final String productSortFilter = "(//div[@class='toolbar-sorter sorter']/select[@class='sorter-options'])[1]";

	public final String sortDesc = "(//a[@class='action sorter-action sort-asc'])[1]";
	public final String sortAsc = "(//a[@class='action sorter-action sort-desc'])[1]/span";
	public final String ascMessage = "Set Ascending Direction";
	...
	public final String addToCart = "//div[@class='product-addtocart-button-warp']/button[@id='product-addtocart-button']";
	...
	public final String firstLoader = "//*[@id='checkout-loader']";
	public final String fieldLoader = "//*[@class='loader']";
